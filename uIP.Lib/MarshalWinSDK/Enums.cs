...
namespace uIP.Lib.MarshalWinSDK
{
    ...
    public enum STD_ACC_RIGHT : uint
    {
        DELETE = 0x00010000,
    ...
    public enum EVT_ACC_RIGHT : uint
    {
        ALL_ACCESS = 0x1F0003,
        MODIFY_STATE = 0x0002,
    }

    public enum MUTEX_ACC_RIGHT : uint
    {
        ALL_ACCESS = 0x1F0001,
        MODIFY_STATE = 0x0001,
    }

    public enum SEM_ACC_RIGHT : uint
    {
        ALL_ACCESS = 0x1F0003,
        MODIFY_STATE = 0x0002,
    }

    public enum TIMER_ACC_RIGHT : uint
    {
        ALL_ACCESS = 0x1F0003,
        MODIFY_STATE = 0x0002,
        QUERY_STATE = 0x0001,
    ...
    public enum LOAD_LIB_FLAGS : uint
    {
