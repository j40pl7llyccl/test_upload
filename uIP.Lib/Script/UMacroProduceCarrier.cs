...
namespace uIP.Lib.Script
{
    ...
    public class UMacroProduceCarrierResult : UMacroProduce
    {
        ...
        {
            if ( _fpHandler != null && _ResultSet != null ) // has specific delegate
                _fpHandler( _ResultSet );
            else if ( _ResultSet != null ) // use default
                UDataCarrier.FreeByIDispose( _ResultSet );
            _ResultSet = null;
        }
    ...
    public class UMacroProduceCarrierPropagation : UMacroProduce
    {
        ...
        protected override void Dispose( bool bDisposing )
        {
            if ( _fpHandler != null && _PropagationCarrier != null ) // has specific delegate
                _fpHandler( _PropagationCarrier );
            else if ( _PropagationCarrier != null ) // use default
                UDataCarrier.FreeByIDispose( _PropagationCarrier );
