...
namespace uIP.Lib.Script
{
    public partial class UScript
    {
        ...
        protected UMacro m_LastExecMacro = null;
        ...
        public ScriptExecReturnCode Running(bool bSyncCall, bool bResetCancel = true,
                                             ...
                                             List<UScriptHistoryCarrier> prevScriptHistorySet = null, bool bHandlePrevHistorySet = true, bool bHandleMacroPropagation = false)
        {
            if (m_bDisposed)
            {
            ...
            try
            {
                ...
                // exec all macros
                for (; execIndex < m_listMacros.Count && execIndex <= nEndIndex;)
                {
