    ...
    public class URectTracker : IDisposable
    {
        ...
        */
        ...
        private void HandleMouseMove( object sender, MouseEventArgs e )
        {
            ...
            IntPtr dc = GdiWinSdkFunctions.GetDC( m_ParentCtrl.Handle );

            IntPtr spen = GdiWinSdkFunctions.CreatePen( 0, 1, GdiWinSdkFunctions.ToRGB( m_ParamSelColor.R, m_ParamSelColor.G, m_ParamSelColor.B ) );
            if ( spen != null ) {
                GdiWinSdkFunctions.SelectObject( dc, spen );
                //GdiWinSdkFunctions.SetROP2( dc, 2 ); // NOTMERGEPEN
                GdiWinSdkFunctions.SetROP2( dc, (int)GdiWinSdkFunctions.ROP2.R2_NOTXORPEN ); // NOTXORPEN
                //GdiWinSdkFunctions.SetROP2( dc, 14 ); // MERGEPENNOT
            }
            Rectangle rect = GetSelectedPosition();
            GdiWinSdkFunctions.MoveToEx( dc, rect.Left, rect.Top, ref dummyPt );
            GdiWinSdkFunctions.LineTo( dc, rect.Left, rect.Bottom );
            GdiWinSdkFunctions.LineTo( dc, rect.Right, rect.Bottom );
            GdiWinSdkFunctions.LineTo( dc, rect.Right, rect.Top );
            GdiWinSdkFunctions.LineTo( dc, rect.Left, rect.Top );
            ...
            case eHit.Inside:
                ...
                break;
            default:
                GdiWinSdkFunctions.ReleaseDC( m_ParentCtrl.Handle, dc );
                GdiWinSdkFunctions.DeleteObject( spen );
                return;
            }
            ...
            GdiWinSdkFunctions.SetROP2( dc, 13 ); // COPYPEN
            GdiWinSdkFunctions.ReleaseDC( m_ParentCtrl.Handle, dc );
            GdiWinSdkFunctions.DeleteObject( spen );
